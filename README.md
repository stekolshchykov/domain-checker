...
- **Rate limiting:** Domain checks enforce a 1-second delay between lookups with up to 4 domains checked in parallel. Large batches are handled with a progress UI.
...
- **Recent additions:**
  ...
  - Multi-registrar pricing grid (Namecheap, GoDaddy, LetsHost, Cloudflare)
  - Full hydration guards eliminating SSR redirect flashes
  - Performance optimization: ~3.4× faster bulk availability checks
- **Future ideas:**
